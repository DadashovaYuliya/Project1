...
def cards (data:str, path:str) -> list:
    ...
    try:
        ...
        filter_param = reader.loc[(reader['Номер карты'].notnull())
...
def top_five_transactions(data:str, path:str) -> list:
    ...
    try:
        ...
        for index, row in result.iterrows():
            new_dict = ({'date': row['Дата операции'].strftime("%d.%m.%Y"),
...
def course_currency(path:str) -> list:
